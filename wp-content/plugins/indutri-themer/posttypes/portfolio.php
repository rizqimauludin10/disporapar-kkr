...
if(!function_exists('gavias_post_type_portfolio')  ){
    function gavias_post_type_portfolio(){
      $labels = array(
          'name'               => __( 'Portfolios', 'indutri-themer' ),
          'singular_name'      => __( 'Portfolio', 'indutri-themer' ),
          'add_new'            => __( 'Add New Portfolio', 'indutri-themer' ),
          'add_new_item'       => __( 'Add New Portfolio', 'indutri-themer' ),
          'edit_item'          => __( 'Edit Portfolio', 'indutri-themer' ),
          'new_item'           => __( 'New Portfolio', 'indutri-themer' ),
          'view_item'          => __( 'View Portfolio', 'indutri-themer' ),
          'search_items'       => __( 'Search Portfolios', 'indutri-themer' ),
          'not_found'          => __( 'No Portfolios found', 'indutri-themer' ),
          'not_found_in_trash' => __( 'No Portfolios found in Trash', 'indutri-themer' ),
          'parent_item_colon'  => __( 'Parent Portfolio:', 'indutri-themer' ),
          'menu_name'          => __( 'Portfolios', 'indutri-themer' ),
      );
