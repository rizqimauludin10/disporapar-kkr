...
class Gavias_Themer_Footer{
  ...
  public function args_post_type_footer(){
    ...
    $args = array(
        'labels'              => $labels,
        'hierarchical'        => true,
        'description'         => __('List Footer', 'indutri-themer'),
        'public'              => true,
        'show_ui'             => true,
        'show_in_menu'        => true,
        'menu_position'       => 5,
    ...
    //             'title' => __('Edit Footer', 'indutri-themer'),
  ...
  public function get_footers(){
    ...
    $footers['__default_option_theme'] = esc_html__('Default Option Theme', 'indutri');
    $footers['__disable_footer'] = esc_html__('Disable Footer', 'indutri');
    $footers['__default'] = __('Default Widget Footer', 'indutri-themer');
    wp_reset_postdata();
