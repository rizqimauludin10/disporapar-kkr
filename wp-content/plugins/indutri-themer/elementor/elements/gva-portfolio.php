...
class GVAElement_Portfolio extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Portfolio', 'indutri-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'portfolio-style-1'         => __( 'Item Portfolio Style I', 'indutri-themer' ),
                    'portfolio-style-2'         => __( 'Item Portfolio Style II', 'indutri-themer' )
                ],
                'condition' => [
        ...
        $this->add_control(
            'isotope_filter',
            [
                'label'     => __('Isotope Filter', 'indutri-themer'),
