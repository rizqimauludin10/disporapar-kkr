...
class GVAElement_Countdown extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Countdown', 'kipso-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'year',
			[
				'label' => __( 'Year', 'kipso-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => date('Y'),
				'placeholder' => __( 'ex: 2019', 'kipso-themer' ),
				'label_block' => true
			]
		);
		$this->add_control(
			'month',
			[
				'label' => __( 'Month', 'kipso-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => '12',
				'placeholder' => __( 'ex: 12', 'kipso-themer' ),
			]
		);
		$this->add_control(
			'day',
			[
				'label' => __( 'Day', 'kipso-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => '01',
				'placeholder' => __( 'ex: 01', 'kipso-themer' ),
			]
		);
		$this->add_control(
			'hour',
			[
				'label' => __( 'Hour', 'kipso-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => '00',
				'placeholder' => __( 'ex: 00', 'kipso-themer' ),
			]
		);
		$this->add_control(
			'minutes',
			[
				'label' => __( 'Minutes', 'kipso-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => '00',
				'placeholder' => __( 'ex: 00', 'kipso-themer' ),
			]
		...
		$this->add_control(
			'box_background',
			[
				'label' => __( 'Background Color', 'kipso-themer' ),
	...
	protected function render() {
		...
		printf( '<div class="gva-element-%s gva-element">', $this->get_name() );
         include $this->get_template('gva-countdown.php');
      print '</div>';
	}
