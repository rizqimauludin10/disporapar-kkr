...
class GVAElement_Box_Hover extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Box Hover', 'indutri-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
         ...
         $repeater->add_control(
            'box_image',
            [
                'label'      => __('Background Image', 'indutri-themer'),
                'dynamic' => [
                  'active' => true,
                ],
                'default'    => [
            ...
            [
                ...
                'default'     => array(
                    array(
                        ...
                        'box_image'    => [
                            'url' => GAVIAS_INDUTRI_PLUGIN_URL . 'elementor/assets/images/image-4.jpg',
                        ],
                        'box_content'  => esc_html__( 'There are many variations of passages of available but the majority have suffered alter randomised words.', 'indutri-themer' ),
                    ),
                    array(
                        'box_title'  => esc_html__('Civil Rights'),
                        'box_image'    => [
                            'url' => GAVIAS_INDUTRI_PLUGIN_URL . 'elementor/assets/images/image-5.jpg',
                        ],
                        'box_content'  => esc_html__( 'There are many variations of passages of available but the majority have suffered alter randomised words.', 'indutri-themer' ),
                    ),
                    array(
        ...
        $this->add_control(
            'box_height',
            [
                'label'      => __('Box Height', 'indutri-themer'),
        ...
        $this->add_control(
            'icon_background',
            [
                'label'     => __('Icon Background Color', 'indutri-themer'),
        ...
        $this->add_control(
            'icon_border_radius',
            [
                'label'      => __('Icon Border Radius', 'indutri-themer'),
