...
class GVAElement_Posts extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Posts', 'indutri-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control( // xx Layout
         ...
         $this->add_control(
            ...
            [
                ...
                'default' => 'grid',
                'options' => [
                    'sticky'        => __( 'Post Large & List', 'indutri-themer' ),
                    'grid'          => __( 'Grid', 'indutri-themer' ),
                    'carousel'      => __( 'Carousel', 'indutri-themer' ),
                    'small_list'    => __( 'Small List', 'indutri-themer' )
                ]
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'post-style-1'         => __( 'Item Post Style I', 'indutri-themer' ),
                    'post-style-2'         => __( 'Item Post Style II', 'indutri-themer' )
                ],
                'condition' => [
        ...
        $this->add_control(
            'image_size',
            [
               'label'     => __('Image Style', 'indutri-themer'),
               'type'      => \Elementor\Controls_Manager::SELECT,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Right List Posts Style', 'indutri-themer' ),
        ...
        $this->add_responsive_control(
            'stick_list_padding',
            [
                'label' => __( 'Padding List Posts', 'indutri-themer' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Background List Posts', 'indutri-themer' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'List Posts Title Color', 'indutri-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
