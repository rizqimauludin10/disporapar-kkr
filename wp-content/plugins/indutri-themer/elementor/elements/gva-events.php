...
class GVAElement_Events extends GVAElement_Base{
    ...
    public function get_title() {
        return __('GVA Events', 'indutri-themer');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'event_start_date' => __( 'Event Start Date', 'indutri-themer' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'event'                   => __( 'Event Item Style I', 'indutri-themer' ),
                    'event-2'           => __( 'Event Item Style II', 'indutri-themer' ),
                ],
                 'default' => 'event',
            ]
        );
