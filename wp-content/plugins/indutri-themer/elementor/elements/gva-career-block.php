...
class GVAElement_Career_Block extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Career Block', 'indutri-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					'url' => GAVIAS_INDUTRI_PLUGIN_URL . 'elementor/assets/images/icon.png',
				],
			]
		);
		...
		$this->add_control(
			'job_type',
			[
				'label' => __( 'Job Type', 'indutri-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => 'Full Time'
			]
		);
		$this->add_control(
			'company',
			[
				'label' => __( 'Company', 'indutri-themer' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->start_controls_section(
			'info_type_style',
			[
				'label' => __( 'Information (Address & Company)', 'indutri-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
