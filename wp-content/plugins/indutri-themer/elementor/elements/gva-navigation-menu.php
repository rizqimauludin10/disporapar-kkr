...
class GVAElement_Navigation_Menu extends GVAElement_Base {
	...
	public function get_title() {
		return __( 'GVA Navigation Menu', 'indutri-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'sub_menu_min_width',
			[
				'label' => __( 'Submenu Min Width (px)', 'indutri-themer' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Main Menu', 'indutri-themer' ),
      ...
      $this->start_controls_tab(
         ...
         [
            'label' => __('Normal', 'indutri-themer'),
         ]
      );
      $this->add_control(
      ...
      $this->end_controls_tabs();
		...
		$this->add_responsive_control(
			'main_menu_padding',
			[
				'label' => __( 'Menu Item Padding', 'indutri-themer' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Sub Menu', 'indutri-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
      ...
      $this->add_control(
         ...
         [
            'label'     => __('Link Color', 'indutri-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
