...
class GVAElement_Work_Process extends GVAElement_Base {  
	...
	public function get_title() {
		return __( 'GVA Work Process', 'indutri-themer' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_icon',
			[
				'label' => __( 'GVA Work Process', 'indutri-themer' ),
			]
		);
		...
		$this->add_responsive_control(
			'box_size',
			[
				'label' => __( 'Box Size', 'indutri-themer' ),
		...
		$this->add_responsive_control(
			'box_padding',
			[
				'label' => __( 'Box Padding', 'indutri-themer' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'default' => [
					'top' 		=> 50,
		...
		$this->add_control(
			...
			[
				'label' => 'Number text',
				'type' => Controls_Manager::TEXT,
				'default' => __( '01', 'indutri-themer' ),
				'placeholder' => __( 'Enter your number', 'indutri-themer' ),
			]
		);
		...
		$this->start_controls_section( //** Section Button
			'section_line',
			[
				'label' => __( 'Line', 'indutri-themer' ),
			]
		);
		$this->add_control(
			'line_left',
			[
				'label' => __( 'Display Line Left', 'indutri-themer' ),
		...
		$this->add_control(
			'line_right',
			[
				'label' => __( 'Display Line Right', 'indutri-themer' ),
				'type'      => Controls_Manager::SWITCHER,
            'default'   => 'yes',
			]
		);
		$this->add_control(
			'line_background',
			[
				'label' => __( 'Line Background', 'indutri-themer' ),
				'type' => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .gsc-work-process .box-content .box-background' => 'background-color: {{VALUE}};',
