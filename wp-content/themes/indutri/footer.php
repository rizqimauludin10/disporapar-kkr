 ...
 * 
 */
$copyright = esc_html__('Copyright 2020 - Company - All rights reserved. Powered by WordPress.', 'indutri');
?>
	...
	<footer id="wp-footer" class="clearfix">
		...
		<?php $footer = apply_filters('indutri_get_footer_layout', null );?>
		...
		<?php if(indutri_get_option('copyright_default', 'yes') == 'yes'){ ?>
			<div class="copyright">
				<div class="container">
		...
		<?php if( indutri_get_option('enable_backtotop', false) ){ ?>
