...
Redux::setSection( $opt_name, array(
   'title'   => esc_html__( 'Portfolio Options', 'indutri' ),
   'icon'    => 'el-icon-website',
   'fields'  => array(
      array(
        'id'  => 'slug_portfolio_post_type',
        'type'  => 'info',
        'raw' => '<h3 style="margin: 0;">' . esc_html__( 'Slug url portfolio post type', 'indutri' ) . '</h3>'
      ),
      array(
        'id' => 'slug_portfolio',
        'type' => 'text',
        'title' => esc_html__('Slug Portfolio', 'indutri'),
        'default' => 'portfolio'
      ),
      array(
      ...
      array(
        ...
        'type' => 'select',
        'title' => esc_html__('Default Archive Page Portfolio Sidebar Config', 'indutri'),
      ...
      array(
        ...
        'type' => 'select',
        'title' => esc_html__('Default Archive Page Portfolio Left Sidebar', 'indutri'),
       ...
       array(
        ...
        'type' => 'select',
        'title' => esc_html__('Default Archive Page Portfolio Right Sidebar', 'indutri'),
      ...
      array(
        ...
        'type'  => 'info',
        'icon'  => true,
        'raw' => '<h3 style="margin: 0;">' . esc_html__( 'Single Portfolio', 'indutri' ) . '</h3>',
      ),
      array(
