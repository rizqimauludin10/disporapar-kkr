<?php
function indutri_path_demo_content(){
	return (__DIR__.'/demo-data/');
}
add_filter('wbc_importer_dir_path', 'indutri_path_demo_content');
	...
	function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
		...
		if ( class_exists( 'RevSlider' ) ) {
			...
			foreach ($wbc_sliders_array as $s) {
				if ( file_exists( indutri_path_demo_content().'main/'. $s ) ) {
					$slider->importSliderFromPost( true, true, indutri_path_demo_content().'main/'.$s );
				}
			}
		}
