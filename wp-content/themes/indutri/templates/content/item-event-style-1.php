...
$start_time = get_post_meta(get_the_id(), 'indutri_start_time', true );
$finish_time = get_post_meta(get_the_id(), 'indutri_finish_time', true );
$address = get_post_meta(get_the_id(), 'indutri_address', true );
$event_time = get_post_meta( get_the_id(), 'indutri__time', true );
$event_color = get_post_meta( get_the_id(), 'indutri_event_color', true );
...
if(!isset($image_size) || empty($image_size)){
  $image_size = 'indutri_medium';
}
?>
<article id="event-<?php the_ID(); ?>"> 
  <div class="event-block-1 <?php echo esc_attr($event_color) ?>">
     ...
     <?php } ?>   
      <div class="event-content">  
          <div class="event-info">
            <h3 class="title"><a href="<?php echo esc_url($link) ?>" rel="bookmark"><?php echo esc_html($title); ?></a></h3>
