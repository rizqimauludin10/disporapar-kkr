 ...
 * 
 */
  $columns_lg = indutri_get_option('blog_columns_lg', '2');
  $columns_md = indutri_get_option('blog_columns_md', '2');
  $columns_sm = indutri_get_option('blog_columns_sm', '1');
  $columns_xs = indutri_get_option('blog_columns_xs', '1');
