...
<ul class="social-networks">
	<?php if((bool)indutri_get_option('product_sharing_facebook',true)): ?>
	<li class="facebook">
	...
	<?php if((bool)indutri_get_option('product_sharing_twitter',true)): ?>
	<li class="twitter">
	...
	<?php if((bool)indutri_get_option('product_sharing_linkedin',true)): ?>
	<li class="linkedin">
	...
	<?php if((bool)indutri_get_option('product_sharing_tumblr',true)): ?>
	<li class="tumblr">
	...
	<?php if((bool)indutri_get_option('product_sharing_google',true)): ?>
	<li class="google">
...
'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" target="_blank">
	...
	<?php if((bool)indutri_get_option('product_sharing_pinterest',true)): ?>
	<li class="pinterest">
	...
	<?php if((bool)indutri_get_option('product_sharing_email',true)): ?>
	<li class="email">
