 ...
 */
    ...
    $default_sidebar_config = indutri_get_option('single_service_sidebar', ''); 
    $default_left_sidebar = indutri_get_option('single_service_left_sidebar', '');
    $default_right_sidebar = indutri_get_option('single_service_right_sidebar', '');
