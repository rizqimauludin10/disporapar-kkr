 ...
 */
    ...
    $page_id = indutri_id();
    $default_sidebar_config = indutri_get_option('single_post_sidebar', 'right-sidebar'); 
    $default_left_sidebar = indutri_get_option('single_post_left_sidebar', 'default_sidebar');
    $default_right_sidebar = indutri_get_option('single_post_right_sidebar', 'default_sidebar');
