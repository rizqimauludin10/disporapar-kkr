...
if ( ! defined( 'ABSPATH' ) ) {
   ...
   $page_id = $event_id = indutri_id();
   $default_sidebar_config = indutri_get_option('single_event_sidebar', 'right-sidebar'); 
   $default_left_sidebar = indutri_get_option('single_event_left_sidebar', 'default_sidebar');
   $default_right_sidebar = indutri_get_option('single_event_right_sidebar', 'default_sidebar');
            ...
            <div id="wp-content" class="wp-content clearfix">
					...
					<div id="tribe-events-content" class="tribe-events-single">
							...
							<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
								<div class="event-single-left">
									<div class="tribe-events-back">
										<a href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf( '&laquo; ' . esc_html_x( 'All %s', '%s Events plural label', 'indutri' ), $events_label_plural ); ?></a>
									</div>
						...
						<div id="tribe-events-footer">
							<!-- Navigation -->
							<nav class="tribe-events-nav-pagination" aria-label="<?php printf( esc_html__( '%s Navigation', 'indutri' ), $events_label_singular ); ?>">
