 ...
 */
   ...
   $sidebar_layout_config = indutri_get_option('archive_portfolio_sidebar', 'right-sidebar'); 
   $left_sidebar = indutri_get_option('archive_portfolio_left_sidebar', 'portfolio_sidebar');
   $right_sidebar = indutri_get_option('archive_portfolio_right_sidebar', 'portfolio_sidebar');
   ...
   $columns_lg = indutri_get_option('portfolio_columns_lg', '4');
   $columns_md = indutri_get_option('portfolio_columns_md', '3');
   $columns_sm = indutri_get_option('portfolio_columns_sm', '2');
   $columns_xs = indutri_get_option('portfolio_columns_xs', '1');
